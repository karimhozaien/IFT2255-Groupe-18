...
public class Authentification {
    ...
    private static final String CHEMIN_ABSOLU_RESIDENT = "/Users/mathiaslarochelle/Documents/School/A24/IFT2255/Projets/Projet 1/Livrable 1/ressources/data/resident_data.json";
    private static final String CHEMIN_ABSOLU_INTERVENANT = "/Users/mathiaslarochelle/Documents/School/A24/IFT2255/Projets/Projet 1/Livrable 1/ressources/data/intervenant_data.json";
    ...
    public static boolean inscrireResident(Scanner scanner) {
        ...
        try {
            ...
            try {
                ...
                manager.sauvegardeUtilisateurAJSON(nouveauResident, CHEMIN_ABSOLU_RESIDENT);
    ...
    public static boolean inscrireIntervenant(Scanner scanner) {
        ...
        try {
            ...
            try {
                UtilisateurManager manager = new UtilisateurManager();
                manager.sauvegardeUtilisateurAJSON(nouvelIntervenant, CHEMIN_ABSOLU_INTERVENANT);
            } catch (Exception exception) {
                System.out.println("Impossible d'enregistrer les informations dans la base de données.");
                exception.printStackTrace();
                return false;
